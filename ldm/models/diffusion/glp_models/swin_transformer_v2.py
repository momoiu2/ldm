...
class WindowAttention(nn.Module):
    ...
    def forward(self, x, mask=None):
        ...
        if self.attn_type == 'cosine_mh':
            ...
            logit_scale = torch.clamp(self.logit_scale, max=max).exp()
...
class SwinTransformerV2(nn.Module):
    ...
    def __init__(self,
        ...
        if isinstance(window_size, ListConfig):
            pass
        ...
        if isinstance(use_shift, ListConfig):
            pass
        ...
        if isinstance(use_checkpoint, ListConfig):
            pass
